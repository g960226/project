...
// static : 정적 멤버 요소를 만들때 사용한다 // 사람의 눈은 두개다 (자료형에 고정되어 있는경우)
// 특정 개체를 지목하지 않아도, 자료형에 각인되어 있는 속성이나 기능을 만들 수 있다	
// 객체를 생성하지 않아도, 클래스로 접근이 가능하다
// 같은 클래스를 사용하는 모든 객체가 공유할 수 있다



// dyanimic // 이 사람의 이름은 ooo이다 (묻는 사람마다 다르다)
...
public class Ex06 {
	public static void main(String[] args) {
		...
		System.out.println("ob2.count : " + ob2.count); // 두번째 객체의 count가 증가되어 있다
		
	// The static field Human.count should be accessed in a static way
	// Human 클래스의 count필드는 정적필드이므로, 정적인 방법으로 접근해야 합니다
